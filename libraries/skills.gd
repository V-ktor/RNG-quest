...
const ABILITY_MODULES = {
	...
	"heavy_weapons":{
		...
		"melee_mod":["force","brutal","reckless","pierce","charged","concussive"],
		"aim":["body","arms","legs","neck"],
	},
	"dirty_fighting":{
		"base_type":["throwing_knife"],
	...
	"brawling":{
		...
		"melee_mod":["force","brutal","quick","charged","stunning","rush"],
	...
	"elemental_magic":{
		...
		"magic_mod":["homing","pumped","high_yield","mana_burn","fuse"],
	...
	"nature_magic":{
		...
		"magic_mod":["homing","pumped","explosive","supersonic","fuse"],
	...
	"celestial_magic":{
		...
		"application":["rocket","beam","explosion"],
		"magic_mod":["vampiric","pumped","restorative","swift","fuse"],
